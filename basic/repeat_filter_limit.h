 ...
 */
class RepeatFilterLimit {
  public:
  RepeatFilterLimit(size_t bar1, size_t threshold1, size_t bar2 = 50 * 1000, size_t threshold2 = 100 * 1000)
      :bar1_(bar1), bar2_(bar2), threshold1_(threshold1), threshold2_(threshold2) {
  }
  /**
  ...
  bool repeat() {
    ...
    if (counter < bar2_) {
      return (counter - bar1_) % threshold1_ == 0;
    }
