...
class fstring {
  ...
  explicit fstring(const std::string_view &other) {
  ...
  friend void swap(fstring &lft, fstring &rht) noexcept {
    for (auto i = 0u; i < N; ++i) {
  ...
  void swap(fstring &rhs) noexcept {
